    ...
    public class CalisanController : Controller
    {
        ...
        public ActionResult Index()
        {
...

            {
                ...
                var isler = (from i in entity.Isler2 where i.isPersonelId == personelId && i.isOkunma == false orderby i.iletilenTarih descending select i).ToList();
        ...
        {
            var tekIs = (from i in entity.Isler2 where i.isId == isId select i).FirstOrDefault();
        ...
        public ActionResult Yap()
        {
            ...
            {
                int personelId = Convert.ToInt32(Session["PersonelId"]);
                var isler = (from i in entity.Isler2 where i.isPersonelId == personelId && i.isDurumId == 1 select i)
        ...
        public ActionResult Takip()
        {
            ...
            {
                int personelId = Convert.ToInt32(Session["PersonelId"]);
                var isler = (from i in entity.Isler2 join d in entity.Durumlar on i.isDurumId equals d.durumId 
